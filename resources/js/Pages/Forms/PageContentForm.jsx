                            ...
                            <Col xs={24} md={12}>
                                <Form.Item label="Extra Body" name="extrabody">
                                    ...
                                    <TextArea
                                        ...
                                        defaultValue={record.extrabody}
                                    />{" "}
                                </Form.Item>{" "}
                            </Col>
                            <Col xs={24} md={24}>
                                <Form.Item label="Page Body" name="body">
                                    {" "}
                                    <TextArea
                                        onChange={(e) =>
                            ...
                            <Col xs={24} md={12}>
                                ...
                                >
                                    ...
                                    <TextArea
                                        ...
                                        defaultValue={record.optionalbody}
                                    />{" "}
                                </Form.Item>{" "}
                            </Col>
                            <Col xs={24} md={12}>
                                <Form.Item
                                    label="Optional Extra Body"
                                    name="optionalextrabody"
                                >
                                    {" "}
                                    <TextArea
                                        onChange={(e) =>
                                        ...
                                        defaultValue={record.optionalextrabody}
                                    />{" "}
                                </Form.Item>{" "}
                            </Col>
                        </Row>
                ...
                <Col xs={24} md={12}>
                    <Form.Item
                        rules={[
                            {
                                required: true,
                                message: "Please Enter Main Header",
                            },
                        ]}
                        label="Main Header"
                        name="mainheader"
                    >
                        <Input
                            ...
                            onChange={(e) =>
                                setData("mainheader", e.target.value)
                            }
                        />
                    </Form.Item>
                </Col>
                <Col xs={24} md={12}>
                    <Form.Item label="Sub Header" name={"subheader"}>
                        <Input
                            ...
                            onChange={(e) =>
                                setData("subheader", e.target.value)
                            }
                        />
                    </Form.Item>
                </Col>
                ...
                <Col xs={24} md={12}>
                    <Form.Item label="Link Text" name="linktext">
                        <Input
                            ...
                            onChange={(e) =>
                                setData("linktext", e.target.value)
                            }
                        />
                    </Form.Item>
                </Col>
