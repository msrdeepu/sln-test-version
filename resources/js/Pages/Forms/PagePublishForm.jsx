    ...
    return (
        <>
            ...
            <Row gutter={[8, 4]}>
                ...
                <Col xs={24} md={8}>
                    <Form.Item
                        ...
                        rules={[
                            {
                                required: true,
                                message: "Please Select Content Access Level",
                            },
                        ]}
                    >
                        <Select
                ...
                <Col xs={24} md={8}>
                    <Form.Item label="Bulk Attachments" name="hasattachments">
                        <Radio.Group
                            name="hasattachments"
                            defaultValue={record.hasattachments}
                            onChange={(e) =>
                                setData("hasattachments", e.target.value)
                            }
                        >
