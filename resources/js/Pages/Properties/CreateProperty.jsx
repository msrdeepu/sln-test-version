...
function CreateProperty({ props, record }) {
    ...
    const sumbmitHandler = (values) => {
        console.log(data);
        router.post("/admin/properties/store", data);
    }
    ...
    return (
        <>
            ...
            <Card title={`Property Details`}>
                <Form layout="vertical" form={form} onFinish={sumbmitHandler}>
                    <Row gutter={[8, 3]}>
                        <Col xs={24} md={12}>
                        ...
                        <Col xs={24} md={12}>
                            <Form.Item label="Plot Facing" name={"plotfacing"}>
                        ...
                        <Col xs={24} md={12}>
                            <Form.Item label="Agent" name={"selectagent"}>
